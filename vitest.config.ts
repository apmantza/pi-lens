...
const wallClockBudgetInclude = [
	...
	"tests/clients/dependency-checker-batch-race.test.ts",
	...
	"tests/clients/lsp/jvm-runtime.test.ts",
	...
	"tests/clients/safe-spawn-exit-idle-wait.test.ts",
	...
	"tests/clients/safe-spawn-windows-env-plumbing.test.ts",
	"tests/clients/shared-checkout-guard.test.ts",
	"tests/clients/zizmor-config.test.ts",
	"tests/clients/zizmor-token-latch.test.ts",
