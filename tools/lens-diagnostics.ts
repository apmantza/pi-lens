...
export function createLensDiagnosticsTool(
	...
	return {
		...
		description:
			'Query pi-lens diagnostics across dispatch runners. mode=delta/all are cache-only and instant; mode=full adds an active LSP scan. Example: use `{mode: "all"}` before declaring edits complete.',
		promptSnippet:
