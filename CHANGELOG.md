...
- **Nested-link diagnostics no longer flag ordinary JSX wrappers (closes #1076)** — require the reported outer element to be an anchor, preserving detection for directly and deeply nested anchors while allowing single and sibling links inside non-anchor containers.
